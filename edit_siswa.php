...
if (isset($_GET['id'])) {
  ...
  $query = "SELECT * FROM siswa,kelas,spp where siswa.nisn='$id' AND siswa.nama_kelas=kelas.nama_kelas AND siswa.id_spp=spp.id_spp";
                ...
                <div class="form-group row align-items-center">
                  ...
                  <div class="col-lg-4 col-md-6">
                    <select name="nama_kelas">
                      ...
                      <?php
                      $idbarangyangdipilih = $data['nama_kelas'];
                      ...
                      ?>
                        <option value="<?php echo $row['nama_kelas']; ?>" <?php if ($row['nama_kelas'] == "$idbarangyangdipilih") { ?> selected="selected" <?php } ?>><?php echo $row['nama_kelas']; ?></option>
                      <?php
